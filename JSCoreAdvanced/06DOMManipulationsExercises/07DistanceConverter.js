function attachEventsListeners(){
    ...
    function convertDistance(){
        ...
        switch(inputUnitsSelectElement.value){
            ...
            case 'm': distanceInMeters = inputDistance; break;
        ...
        switch(outputUnitsSelectElement.value){
            case 'km': outputDistance = distanceInMeters / 1000; break;
            case 'm': outputDistance = distanceInMeters; break;
            case 'cm': outputDistance = distanceInMeters / 0.01; break;
            case 'mm': outputDistance = distanceInMeters / 0.001; break;
            case 'mi': outputDistance = distanceInMeters / 1609.34; break;
            case 'yrd': outputDistance = distanceInMeters / 0.9144; break;
            case 'ft': outputDistance = distanceInMeters / 0.3048; break;
            case 'in': outputDistance = distanceInMeters / 0.0254; break;
        }
