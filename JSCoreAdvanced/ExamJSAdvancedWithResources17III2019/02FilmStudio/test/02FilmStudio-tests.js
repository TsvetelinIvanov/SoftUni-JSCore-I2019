...
describe('SoftUniFy', function () {
    ...
    describe('makeMovie(filmName, roles)', function () {
        ...
        it('should throw by invalid arguments count', function () {
            expect(() => { filmStudio.makeMovie('Vanilla scay'); }).to.throw('Invalid arguments count');
        });
        it('should throw by invalid arguments count', function () {
            expect(() => { filmStudio.makeMovie('Vanilla scay', ['roles'], 'wrongArgument'); }).to.throw('Invalid arguments count');
        });
        ...
        it('should throw by invalid argument roles', function () {
            expect(() => { filmStudio.makeMovie('Vanilla scay', 'roles'); }).to.throw('Invalid arguments');
            expect(() => { filmStudio.makeMovie('Vanilla scay', { 'roles': 1 }); }).to.throw('Invalid arguments');
            expect(() => { filmStudio.makeMovie('Vanilla scay', 1); }).to.throw('Invalid arguments');
        });
    ...
    describe('casting(actor, role)', function () {
        ...
        it('should return success message for find role', function () {
            filmStudio.makeMovie('The Avengers', ['Iron-Man', 'Thor', 'Hulk', 'Arrow guy']);
    ...
    describe('lookForProducer(film)', function () {
        ...
        it('should throw error for not finded film', function () {
            filmStudio.makeMovie('The Avengers', ['Iron-Man', 'Thor', 'Hulk', 'Arrow guy']);
