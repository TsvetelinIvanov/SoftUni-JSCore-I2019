function solve() {
    ...
    switch (neededInformation) {
        case 'name': resultElement.textContent = `Mr/Ms, ${name}, have a nice flight!`; break;
        case 'flight': resultElement.textContent = `Your flight number ${flight} is from ${airport[1]} to ${airport[2]}.`; break;
